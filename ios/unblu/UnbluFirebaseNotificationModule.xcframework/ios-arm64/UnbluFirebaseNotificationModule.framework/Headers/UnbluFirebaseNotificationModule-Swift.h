...
#ifndef UNBLUFIREBASENOTIFICATIONMODULE_SWIFT_H
#define UNBLUFIREBASENOTIFICATIONMODULE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="UnbluFirebaseNotificationModule",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
///   </li>
///   <li>
///     You should only use this if you’re not inheriting your AppDelegate from <code>UnbluFirebaseUIApplicationDelegate</code>.
///   </li>
/// </ul>
SWIFT_CLASS("_TtC31UnbluFirebaseNotificationModule36UnbluFirebaseNotificationCoordinator")
@interface UnbluFirebaseNotificationCoordinator : NSObject
/// Creates an instance of a <code>UnbluFirebaseNotificationCoordinator</code>
...
@interface UnbluFirebaseNotificationCoordinator (SWIFT_EXTENSION(UnbluFirebaseNotificationModule)) <FIRMessagingDelegate>
...
SWIFT_PROTOCOL("_TtP31UnbluFirebaseNotificationModule44UnbluFirebaseNotificationCoordinatorDelegate_")
...
/// \param unbluFirebaseNotificationCoordinator The firebase coordinator which received the message
///
/// \param token The push notification token
///
- (void)unbluFirebaseNotificationCoordinator:(UnbluFirebaseNotificationCoordinator * _Nonnull)unbluFirebaseNotificationCoordinator didReceiveRegistrationToken:(NSString * _Nullable)token;
@end
...
SWIFT_CLASS("_TtC31UnbluFirebaseNotificationModule34UnbluFirebaseUIApplicationDelegate")
@interface UnbluFirebaseUIApplicationDelegate : UIResponder <UIApplicationDelegate>
/// The window used by iOS to attach UI content. If you create a <code>UIWindow</code> programmatically instead of using Storyboard, you should set it to this property.
@property (nonatomic, strong) UIWindow * _Nullable window;
/// <ul>
///   <li>
///     Uses <code>UnbluFirebaseNotificationCoordinator</code> and calls FirebaseApp.configure and sets the Messaging.messaging().delegate and checks if there was an initial notification from which the app was started.
///   </li>
///   <li>
...
@interface UnbluFirebaseUIApplicationDelegate (SWIFT_EXTENSION(UnbluFirebaseNotificationModule)) <UnbluFirebaseNotificationCoordinatorDelegate>
/// Will be called when the push notification token was received/updated via Firebase
/// \param unbluFirebaseNotificationCoordinator The firebase coordinator which received the message
///
/// \param token The push notification token
